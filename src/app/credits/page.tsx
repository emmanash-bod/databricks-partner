...
export const metadata: Metadata = {
  ...
  description:
    "We fund your deals — Blue Orange Digital provides Databricks consumption credits for opportunities brought in by Databricks reps.",
};
    ...
    <div className="relative flex flex-col items-center text-center">
      ...
      {!isLast && (
        <div className="hidden lg:block absolute top-10 -right-[calc(50%-20px)] w-[calc(100%-40px)]">
          <div className="h-px w-full bg-gradient-to-r from-dbricks/40 to-dbricks/10" />
          <svg className="absolute -right-2 -top-1.5 w-4 h-4 text-dbricks/40" fill="currentColor" viewBox="0 0 24 24">
      ...
      {/* Icon box */}
      <div className="w-20 h-20 rounded-md bg-stone-100 border border-dark-200 flex items-center justify-center mb-4 relative">
        <div className="absolute -top-2 -left-2 w-7 h-7 rounded-md bg-orange flex items-center justify-center text-white font-mono text-xs font-bold shadow-lg shadow-orange/30">
          {number}
        </div>
        {icon}
      </div>

      <h3 className="text-lg font-serif font-bold text-dark mb-2">{title}</h3>
...
export default function Credits() {
  return (
    <>
      {/* ── HERO ─────────────────────────────────────────────────── */}
      <section className="relative gradient-hero dot-grid overflow-hidden">
        ...
        <div className="relative container-max section-padding pt-24 sm:pt-32 lg:pt-40 pb-16">
          <p className="section-label mb-6">Credit Program</p>
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-serif font-bold text-white max-w-4xl leading-[1.1] mb-6">
            We Fund{" "}
          ...
          <p className="text-lg sm:text-xl text-white/60 max-w-2xl leading-relaxed mb-8">
            Blue Orange Digital provides Databricks consumption credits for opportunities exclusively brought in by Databricks reps. De-risk the deal for your customer and accelerate time-to-close.
          </p>
      ...
      <section className="bg-white section-padding">
        <div className="container-max">
          <div className="text-center mb-14">
            ...
            <h2 className="text-3xl sm:text-4xl font-serif font-bold text-dark mb-4">Simple 5-Step Process</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-4">
            <Step
              ...
              icon={
                <svg className="w-8 h-8 text-dbricks" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      {/* ── ELIGIBILITY ──────────────────────────────────────────── */}
      <section className="bg-stone-100 dot-grid-light section-padding">
        <div className="container-max">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              <p className="section-label mb-4">Eligibility</p>
              <h2 className="text-3xl font-serif font-bold text-dark mb-6">Who Qualifies?</h2>
              <ul className="space-y-4">
                {[
                  ...
                  <li key={item} className="flex gap-3">
                    <svg className="w-5 h-5 text-dbricks shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            {/* Credit Tiers */}
            <div className="p-8 rounded-md bg-white border-t-[3px] border-t-dbricks shadow-sm">
              <h3 className="text-xl font-serif font-bold text-dark mb-6">Credit Tiers</h3>
              <div className="space-y-4">
                {[
                  ...
                  <div key={t.tier} className="flex items-center gap-4 p-4 rounded-md bg-stone-100 border border-dark-200">
                    <div className="w-12 h-12 rounded-md bg-dbricks/10 flex items-center justify-center shrink-0">
                      <span className="text-dbricks font-mono font-bold text-sm">{t.tier[0]}</span>
                    </div>
                    <div className="flex-1">
                      <div className="flex items-center justify-between mb-1">
                        <span className="font-bold text-dark">{t.tier}</span>
                        <span className="text-sm font-mono font-semibold text-dbricks">{t.range}</span>
                      </div>
      ...
      <section className="bg-white section-padding">
        <div className="container-max">
          <div className="p-8 md:p-12 rounded-md gradient-dark dot-grid relative overflow-hidden">
            <div className="absolute inset-0 overflow-hidden">
              <div className="absolute -top-20 -right-20 w-72 h-72 rounded-full bg-dbricks/5 blur-3xl" />
            </div>
            <div className="relative flex flex-col md:flex-row gap-8 items-center">
              <div className="flex-1">
                <p className="section-label mb-4">Proof Point</p>
                <h3 className="text-2xl font-serif font-bold text-white mb-3">Sunny Sky Products</h3>
              ...
              <div className="grid grid-cols-3 gap-4 shrink-0">
                {[
                  ...
                  <div key={s.label} className="text-center p-4 rounded-md bg-white/5 border border-white/10">
                    <div className="text-2xl font-bold text-amber">{s.stat}</div>
      ...
      <section className="bg-stone-100 dot-grid-light section-padding">
        <div className="container-max text-center">
          ...
          <h2 className="text-3xl sm:text-4xl font-serif font-bold text-dark mb-4">Have a Deal in Mind?</h2>
