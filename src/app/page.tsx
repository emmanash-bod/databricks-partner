...
function PlaceholderImage({ className = "", label }: { className?: string; label?: string }) {
  return (
    <div className={`relative overflow-hidden rounded-xl bg-gradient-to-br from-navy-400/80 to-navy ${className}`}>
...
function HeadshotPlaceholder({ initials }: { initials: string }) {
  return (
    <div className="w-20 h-20 rounded-full bg-gradient-to-br from-orange/80 to-dbricks/80 flex items-center justify-center ring-2 ring-white/10">
...
function IconDatabricks() {
  return (
    <div className="w-12 h-12 rounded-xl bg-dbricks/10 flex items-center justify-center">
...
function IconOW() {
  return (
    <div className="w-12 h-12 rounded-xl bg-navy-200/10 flex items-center justify-center">
      <svg className="w-6 h-6 text-navy-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <>
      ...
      <section className="relative gradient-hero overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <svg className="absolute bottom-0 left-0 right-0 w-full opacity-[0.03]" viewBox="0 0 1440 320">
            <path d="M0,224L48,208C96,192,192,160,288,154.7C384,149,480,171,576,186.7C672,203,768,213,864,202.7C960,192,1056,160,1152,149.3C1248,139,1344,149,1392,154.7L1440,160L1440,320L0,320Z" fill="#FF6B35" />
          </svg>
        </div>
        ...
        <div className="relative container-max section-padding pt-24 sm:pt-32 lg:pt-40 pb-20">
          ...
          <div className="flex items-center gap-3 mb-8">
            <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 backdrop-blur-sm">
              {/* Blue Orange logo placeholder */}
              <div className="w-7 h-7 rounded-md bg-gradient-to-br from-orange to-orange-600 flex items-center justify-center">
                <span className="text-white font-bold text-xs">BO</span>
              </div>
              <span className="text-white/40 text-sm">×</span>
              {/* Databricks logo placeholder */}
              <div className="w-7 h-7 rounded-md bg-gradient-to-br from-dbricks to-dbricks-600 flex items-center justify-center">
                <span className="text-white font-bold text-xs">DB</span>
              </div>
              <span className="text-white/60 text-sm font-medium">Partner Portal</span>
            </div>
          </div>
      ...
      {/* ── TRUST STRIP ────────────────────────────────────────── */}
      <section className="bg-navy-400 border-y border-white/5">
        <div className="container-max px-4 sm:px-6 lg:px-8 py-8">
          <div className="grid grid-cols-2 md:grid-cols-5 gap-6 md:gap-4">
            ...
            <div className="text-center">
              ...
              <div className="text-xs sm:text-sm text-white/60 mt-1">Consulting Partner</div>
            </div>
            <div className="text-center">
              <div className="text-lg sm:text-xl font-bold text-white">SOC 2</div>
              <div className="text-xs sm:text-sm text-white/60 mt-1">Type II Certified</div>
            </div>
            <div className="text-center col-span-2 md:col-span-1">
              <div className="text-lg sm:text-xl font-bold text-white">Oliver Wyman</div>
              <div className="text-xs sm:text-sm text-white/60 mt-1">Backed</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white section-padding">
        <div className="container-max">
          <div className="text-center mb-12">
            <p className="text-sm font-semibold text-orange uppercase tracking-wider mb-3">For Databricks AEs</p>
            <h2 className="text-3xl sm:text-4xl font-bold text-navy mb-4">Why AEs Choose Blue Orange</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {/* Card 1 */}
            <div className="group p-6 rounded-2xl border border-navy/5 bg-white hover:shadow-xl hover:shadow-navy/5 transition-all duration-300">
              <IconPE />
              <h3 className="text-lg font-bold text-navy mt-4 mb-2">PE & Mid-Market Focus</h3>
            ...
            <div className="group p-6 rounded-2xl border border-navy/5 bg-white hover:shadow-xl hover:shadow-navy/5 transition-all duration-300">
              <IconDatabricks />
              <h3 className="text-lg font-bold text-navy mt-4 mb-2">Databricks-First Architecture</h3>
              <p className="text-sm text-navy-200 leading-relaxed">
            ...
            <div className="group p-6 rounded-2xl border border-navy/5 bg-white hover:shadow-xl hover:shadow-navy/5 transition-all duration-300">
              <IconExec />
              <h3 className="text-lg font-bold text-navy mt-4 mb-2">Executive Accessibility</h3>
              <p className="text-sm text-navy-200 leading-relaxed">
            ...
            <div className="group p-6 rounded-2xl border border-navy/5 bg-white hover:shadow-xl hover:shadow-navy/5 transition-all duration-300">
              <IconOW />
              <h3 className="text-lg font-bold text-navy mt-4 mb-2">Backed by Oliver Wyman</h3>
              <p className="text-sm text-navy-200 leading-relaxed">
      ...
      <section className="bg-gray-50 section-padding">
        <div className="container-max">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-sm font-semibold text-orange uppercase tracking-wider mb-3">Meet the Team</p>
              <h2 className="text-3xl sm:text-4xl font-bold text-navy mb-4">Message from Our Founders</h2>
            ...
            {/* Video placeholder */}
            <div className="relative aspect-video rounded-2xl overflow-hidden bg-gradient-to-br from-navy to-navy-400 shadow-2xl shadow-navy/20">
              <svg className="absolute inset-0 w-full h-full opacity-[0.06]" viewBox="0 0 400 225">
                <circle cx="60" cy="40" r="80" fill="#FF6B35" />
                <circle cx="340" cy="185" r="100" fill="#FF3621" />
                <rect x="120" y="70" width="160" height="85" rx="8" fill="#FF6B35" opacity="0.3" />
              </svg>
              {/* Play button */}
              <div className="absolute inset-0 flex items-center justify-center">
              ...
              <div className="absolute bottom-4 left-4 right-4">
                <p className="text-white/40 text-xs">Video coming soon — placeholder</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="bg-white section-padding">
        <div className="container-max">
          <div className="text-center mb-12">
            <p className="text-sm font-semibold text-orange uppercase tracking-wider mb-3">Ready-Made Packages</p>
            <h2 className="text-3xl sm:text-4xl font-bold text-navy mb-4">Featured Offers</h2>
            <p className="text-navy-200 max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {/* Scout — highlighted */}
            <div className="relative p-6 rounded-2xl border-2 border-dbricks/20 bg-gradient-to-br from-dbricks/[0.02] to-transparent hover:shadow-xl hover:shadow-dbricks/5 transition-all duration-300">
              <div className="absolute top-4 right-4">
                <span className="inline-flex items-center px-2.5 py-1 rounded-full text-[10px] font-bold bg-dbricks/10 text-dbricks border border-dbricks/20">
                  PARTNER SOLUTION
                </span>
              </div>
              <div className="w-12 h-12 rounded-xl bg-dbricks/10 flex items-center justify-center mb-4">
                <svg className="w-6 h-6 text-dbricks" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                </svg>
              </div>
              <h3 className="text-lg font-bold text-navy mb-2">Databricks Scout</h3>
            ...
            <div className="relative p-6 rounded-2xl border-2 border-orange/20 bg-gradient-to-br from-orange/[0.03] to-transparent hover:shadow-xl hover:shadow-orange/5 transition-all duration-300">
              <div className="absolute top-4 right-4">
                <span className="inline-flex items-center px-2.5 py-1 rounded-full text-[10px] font-bold bg-orange/10 text-orange border border-orange/20">
                  EXCLUSIVE OFFER
                </span>
              </div>
              ...
              <h3 className="text-lg font-bold text-navy mb-2">Value-Based Pricing</h3>
              <p className="text-sm text-navy-200 leading-relaxed mb-4">
            ...
            {/* Blueprint */}
            <div className="p-6 rounded-2xl border border-navy/5 bg-white hover:shadow-xl hover:shadow-navy/5 transition-all duration-300">
              ...
              <h3 className="text-lg font-bold text-navy mb-2">Blueprint for Databricks</h3>
              <p className="text-sm text-navy-200 leading-relaxed mb-4">
                Free data & AI maturity scan that identifies Databricks product adoption opportunities. Offer it to every prospect.
              </p>
              <Link href="/offers" className="text-sm font-semibold text-navy-300 hover:text-navy transition-colors">
            ...
            <div className="p-6 rounded-2xl border border-navy/5 bg-white hover:shadow-xl hover:shadow-navy/5 transition-all duration-300">
              ...
              <h3 className="text-lg font-bold text-navy mb-2">LakehouseIQ Assessment</h3>
              <p className="text-sm text-navy-200 leading-relaxed mb-4">
            ...
            <div className="p-6 rounded-2xl border border-navy/5 bg-white hover:shadow-xl hover:shadow-navy/5 transition-all duration-300">
              ...
              <h3 className="text-lg font-bold text-navy mb-2">Executive Strategy Sprint</h3>
              <p className="text-sm text-navy-200 leading-relaxed mb-4">
            ...
            <div className="p-6 rounded-2xl border border-navy/5 bg-white hover:shadow-xl hover:shadow-navy/5 transition-all duration-300">
              ...
              <h3 className="text-lg font-bold text-navy mb-2">Databricks Credit Program</h3>
              <p className="text-sm text-navy-200 leading-relaxed mb-4">
                We fund your deals. Co-funded Databricks consumption credits for opportunities sourced by Databricks reps.
              </p>
              <Link href="/credits" className="text-sm font-semibold text-navy-300 hover:text-navy transition-colors">
        ...
        <div className="container-max">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <h2 className="text-3xl font-bold text-navy mb-4">Sunny Sky Products</h2>
              <h3 className="text-lg text-navy-200 mb-4">Unified Data Platform — Transforming Operations with Databricks</h3>
              <p className="text-navy-200 leading-relaxed mb-6">
              ...
              <div className="grid grid-cols-3 gap-4 mb-6">
                <div className="text-center p-3 rounded-xl bg-white border border-navy/5">
                  <div className="text-2xl font-bold text-navy">3x</div>
                  <div className="text-xs text-navy-200 mt-1">Faster Reporting</div>
                </div>
                <div className="text-center p-3 rounded-xl bg-white border border-navy/5">
                  <div className="text-2xl font-bold text-navy">40%</div>
                  <div className="text-xs text-navy-200 mt-1">Cost Reduction</div>
                </div>
                <div className="text-center p-3 rounded-xl bg-white border border-navy/5">
                  <div className="text-2xl font-bold text-navy">100%</div>
                  <div className="text-xs text-navy-200 mt-1">On Databricks</div>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={exec.initials} className="text-center group">
                ...
                <h3 className="text-base font-bold text-navy">{exec.name}</h3>
                <p className="text-sm text-orange font-medium mb-2">{exec.title}</p>
                <p className="text-xs text-navy-200 leading-relaxed mb-4">{exec.desc}</p>
                <div className="flex items-center justify-center gap-3">
                  ...
                  <a href="#" className="text-xs text-navy-200 hover:text-navy transition-colors">
                    LinkedIn
                  </a>
                </div>
              </div>
      ...
      <section className="gradient-navy section-padding">
        <div className="container-max">
          <div className="text-center mb-12">
            <p className="text-sm font-semibold text-orange uppercase tracking-wider mb-3">Relationship Building</p>
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">Co-Sponsor an Event</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div key={venue.name} className="group rounded-2xl overflow-hidden border border-white/10 hover:border-white/20 transition-all duration-300">
                {/* Venue image placeholder */}
                <div className="relative h-48 bg-gradient-to-br from-navy-300/50 to-navy overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  <p className="text-xs text-orange font-medium mb-3">{venue.type} &middot; {venue.capacity}</p>
                  <p className="text-sm text-white/50 leading-relaxed mb-4">{venue.desc}</p>
