...
export const metadata: Metadata = {
  ...
  description:
    "Outcome-aligned pricing — Blue Orange Digital fees tie to measurable business outcomes, not time-and-materials.",
};
  ...
  return (
    <>
      ...
      <section
        ...
        style={{ background: "linear-gradient(135deg, #1A1A1A 0%, #2D1B00 50%, #1A1A1A 100%)" }}
      >
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute -top-40 -right-40 w-96 h-96 rounded-full bg-amber/10 blur-3xl" />
          <div className="absolute -bottom-40 -left-40 w-96 h-96 rounded-full bg-orange/5 blur-3xl" />
          <div className="absolute inset-0 bg-gradient-to-b from-amber/[0.03] to-transparent" />
        </div>

        <div className="relative container-max section-padding pt-24 sm:pt-32 lg:pt-40 pb-16">
          {/* Exclusive badge */}
          <div className="flex items-center gap-3 mb-6">
            <span className="inline-flex items-center px-4 py-2 rounded-md font-mono text-[10px] tracking-[0.22em] uppercase font-bold bg-amber/20 text-amber border border-amber/30 shadow-lg shadow-amber/10">
              <svg className="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 24 24">
                <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" />
              </svg>
              Exclusive Partner Offer
            </span>
            <span className="hidden sm:inline-flex items-center px-3 py-1.5 rounded-md font-mono text-[10px] tracking-[0.22em] uppercase font-semibold bg-white/5 text-white/50 border border-white/10">
          ...
          <a href="#" className="btn-primary text-base px-8 py-4 bg-gradient-to-r from-amber to-orange hover:from-amber-500 hover:to-orange-500">
        ...
        <div className="container-max">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <h2 className="text-3xl font-serif font-bold text-dark mb-6">Fees Tied to Results</h2>
              ...
              <div className="p-4 rounded-md bg-amber-50 border border-amber-200 mt-6">
                <div className="flex items-start gap-3">
                  <svg className="w-5 h-5 text-amber-700 shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" />
                  </svg>
            ...
            {/* Why AEs care */}
            <div>
              <p className="section-label mb-4">Why You Should Care</p>
              <h2 className="text-3xl font-serif font-bold text-dark mb-6">Your Closing Advantage</h2>
              <div className="space-y-4">
                {[
                  ...
                  <div key={item.title} className="flex gap-4 p-4 rounded-md bg-stone-100 border border-dark-200">
                    <svg className="w-5 h-5 text-amber shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <section className="bg-stone-100 dot-grid-light section-padding">
        <div className="container-max">
          <div className="text-center mb-12">
            <p className="section-label justify-center mb-4">Qualification</p>
            <h2 className="text-3xl sm:text-4xl font-serif font-bold text-dark mb-4">Is Your Deal Eligible?</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={item.signal} className="p-6 rounded-md bg-white border-t-[3px] border-t-amber shadow-sm hover:shadow-lg transition-shadow duration-300">
                <div className="w-12 h-12 rounded-md bg-amber/10 flex items-center justify-center mb-4">
                  <svg className="w-6 h-6 text-amber" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    {item.icon}
                  </svg>
                </div>
                <h3 className="text-lg font-serif font-bold text-dark mb-2">{item.signal}</h3>
      ...
      >
        ...
        <div className="relative container-max section-padding text-center">
          <span className="inline-flex items-center px-4 py-2 rounded-md font-mono text-[10px] tracking-[0.22em] uppercase font-bold bg-amber/20 text-amber border border-amber/30 mb-6">
            <svg className="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 24 24">
              <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" />
            </svg>
            Exclusive Partner Offer
