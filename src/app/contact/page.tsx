...
export const metadata: Metadata = {
  title: "Contact & Book a Call | Blue Orange Digital x Databricks",
  description:
    ...
    <>
      ...
      <section className="relative gradient-dark overflow-hidden">
        ...
        <div className="relative container-max section-padding pt-24 sm:pt-32 lg:pt-40 pb-16">
          <p className="font-mono text-[10px] tracking-[0.22em] uppercase text-dbricks mb-4">Zero Friction</p>
      ...
      <section className="bg-white section-padding">
        <div className="container-max">
          <div className="text-center mb-12">
            <p className="font-mono text-[10px] tracking-[0.22em] uppercase text-dbricks mb-3">Direct Booking</p>
            <h2 className="font-serif text-3xl sm:text-4xl font-bold text-dark mb-4">Choose Your Contact</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-4xl mx-auto">
            {executives.map((exec) => (
              <div key={exec.initials} className="p-6 rounded-md border border-dark/5 bg-white hover:shadow-xl hover:shadow-dark/5 transition-all duration-300">
                <div className="flex items-start gap-4 mb-4">
                  <div className="w-16 h-16 rounded-full bg-gradient-to-br from-dbricks/80 to-amber/80 flex items-center justify-center ring-2 ring-white shadow-lg shrink-0">
                    <span className="text-white font-bold text-lg">{exec.initials}</span>
                  </div>
                  <div>
                    <h3 className="font-serif text-lg font-bold text-dark">{exec.name}</h3>
                    <p className="font-mono text-[10px] tracking-[0.22em] uppercase text-dbricks">{exec.title}</p>
                  </div>
                </div>
                <p className="text-sm text-muted leading-relaxed mb-5">{exec.desc}</p>
                <a
                  href={exec.calendly}
                  className="flex items-center justify-center w-full px-4 py-3 rounded text-sm font-semibold text-white bg-orange hover:bg-orange-500 transition-all duration-200 hover:shadow-lg hover:shadow-orange/25"
                >
      ...
      <section className="bg-stone-100 section-padding">
        <div className="container-max">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Email */}
            <div className="p-6 rounded-md bg-white border border-dark/5">
              ...
              <h3 className="font-serif text-lg font-bold text-dark mb-2">General Email</h3>
              <p className="text-sm text-muted mb-4">For non-urgent inquiries, partnership questions, or general information.</p>
            ...
            <div className="p-6 rounded-md bg-white border border-dark/5">
              ...
              <h3 className="font-serif text-lg font-bold text-dark mb-2">Add Us to Your Deal Channel</h3>
              <p className="text-sm text-muted mb-4">
                Invite us to your Slack or Teams deal channel for real-time collaboration.
              </p>
              <div className="space-y-2 text-sm text-muted">
                <p><strong className="text-dark">Slack:</strong> Invite <code className="text-xs bg-stone-100 px-1.5 py-0.5 rounded">@blueorange-team</code> to your channel</p>
                <p><strong className="text-dark">Teams:</strong> Add <code className="text-xs bg-stone-100 px-1.5 py-0.5 rounded">databricks@blueorange.digital</code> as a guest</p>
              </div>
            </div>
            ...
            <div className="p-6 rounded-md bg-white border border-dark/5">
              ...
              <h3 className="font-serif text-lg font-bold text-dark mb-2">Response SLA</h3>
              <p className="text-sm text-muted mb-4">We take responsiveness seriously. Every inquiry gets a human response.</p>
      ...
      <section className="bg-white section-padding">
        <div className="container-max">
          <div className="text-center mb-12">
            <p className="font-mono text-[10px] tracking-[0.22em] uppercase text-dbricks mb-3">Our Offices</p>
            <h2 className="font-serif text-3xl sm:text-4xl font-bold text-dark">Where to Find Us</h2>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
            {/* NYC */}
            <div className="p-6 rounded-md border border-dark/5 hover:shadow-lg transition-shadow duration-300">
              <div className="flex items-center gap-2 mb-3">
                <span className="px-2.5 py-1 text-xs font-bold text-orange bg-orange/10 rounded-full">HQ</span>
                <span className="text-sm font-semibold text-dark">New York, NY</span>
              </div>
              ...
              {/* Placeholder map */}
              <div className="aspect-[2/1] rounded-md bg-gradient-to-br from-dark/50 to-dark overflow-hidden relative">
            ...
            <div className="p-6 rounded-md border border-dark/5 hover:shadow-lg transition-shadow duration-300">
              <div className="flex items-center gap-2 mb-3">
                <span className="text-sm font-semibold text-dark">Washington, DC</span>
              </div>
              <p className="text-muted leading-relaxed mb-3">
                Washington, DC<br />
